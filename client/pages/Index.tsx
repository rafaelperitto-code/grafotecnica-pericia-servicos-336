        ...
        <div className="container mx-auto px-4 py-20 md:py-32 relative">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-slate-900 hover:bg-slate-800 text-white px-8 py-3 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2 group">
                Solicitar Avaliação
                <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="border-2 border-slate-900 text-slate-900 hover:bg-slate-50 px-8 py-3 rounded-lg font-semibold transition-colors">
                Ver Portfólio
              </button>
            </div>
            ...
            <div className="mt-12 flex flex-col sm:flex-row gap-8">
              <div>
                ...
                <p className="text-slate-600 text-sm">Avaliações Concluídas</p>
              </div>
              <div>
                <p className="text-3xl font-bold text-slate-900">98%</p>
                <p className="text-slate-600 text-sm">Taxa de Precisão</p>
              </div>
              <div>
                <p className="text-3xl font-bold text-slate-900">15+</p>
                <p className="text-slate-600 text-sm">Anos de Experiência</p>
              </div>
            </div>
          </div>
        </div>
